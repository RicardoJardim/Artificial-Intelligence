...
rotacoes_apanhar_peca = 1.2
rotacoes_apanhar_peca_restante = 1.5
...
def apanha_peca(peca):
    gs.mode = 'GYRO-RATE'
    gs.mode = 'GYRO-ANG'
    
    if peca == 1: #apanhar peca para a frente
        tank.on_for_rotations(SpeedPercent(potencia_andar_Frente),SpeedPercent(potencia_andar_Frente), rotacoes_apanhar_peca) #frente
        garra.on_for_rotations(SpeedPercent(potencia_garra_apanhar), rotacoes_dar_navalhada)
        tank.on_for_rotations(SpeedPercent(potencia_andar_Frente),SpeedPercent(potencia_andar_Frente),rotacoes_apanhar_peca_restante)
         

    elif peca == 2: #apanhar peca para a direita
    ...
    elif peca == 3: #apanhar peca para tras
        tank.on(SpeedPercent(potencia_esquerda_rodar_1), SpeedPercent(potencia_direita_rodar_1))
